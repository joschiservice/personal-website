...
const en = {
  ...
  tools: {
    label: "04 / Signature deck",
    title: "Eight cards. One working stack.",
    description:
      "A deliberately small collection of the technologies that define how I build—from typed product surfaces to services, data, and production operations.",
    deckLabel: "Signature deck · First edition",
    completeSet: "08 cards / complete set",
    rarityGuideLabel: "Rarity guide",
    collectionLabel: "Signature technology card collection",
    editionLabel: "First edition · 2026",
    ...
    rarityNotes: {
      Rare: "Trusted utility",
      Epic: "Deep specialism",
      Legendary: "Stack-defining core",
    },
