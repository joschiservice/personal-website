...
const milestoneTranslations: Record<string, MilestoneTranslation> = {
  "independent-products": {
    ...
    summary:
      "ShiftIQと、後にRosterSpecとなるソルバー開発は、同じプロジェクトとして始まりました。介護サービスの管理者と直接協力し、ShiftIQをMVP後の段階からパイロット導入直前まで開発しました。再利用可能なスケジューリング基盤はRosterSpecとして継続し、現在はオープンソース公開に向けて準備しています。",
    impact: [
      { label: "プロダクト段階", value: "MVP後" },
      { label: "業務検証", value: "介護サービス管理者" },
      { label: "計画作業", value: "数時間 → 数分" },
      { label: "現在", value: "公開準備中" },
    ],
  ...
  rosterspec: {
    ...
    summary:
      "RosterSpecはShiftIQと同時に、その再利用可能なソルバー基盤として始まりました。現在は、業務要件を明示的かつテスト可能なハード制約とソフト制約として表現する、汎用オープンソース・スケジューリングシステムへ発展させています。公開リポジトリとドキュメントを準備し、ルール変更が生成結果へ与える影響を示すインタラクティブなプレイグラウンドも検討中です。",
    tasks: [
      ...
      "オープンソース公開に向け、コードベース、ドキュメント、サンプルを準備中",
    ],
    skills: ["Python", "OR-Tools", "制約プログラミング", "LLM評価"],
    routeLabel: "オープンソース展開",
  },
  "ihk-qualification": {
...
const ja: Dictionary = {
  ...
  tools: {
    label: "04 / 技術スタック",
    title: "ツールは手段であり、主役ではありません。",
    description:
      "UI、プロダクト向けサービス、外部連携、本番インフラを形にするために使う技術を、少しゲーム感覚で紹介します。",
    all: "すべて",
    featured: "主要技術",
    filterLabel: "カテゴリーで技術を絞り込む",
    resultsLabel: "件の技術を表示中",
    categories: en.tools.categories.map((category) => categoryLabels[category]),
