...
const ja: Dictionary = {
  ...
  contact: {
    ...
    directoryTitle: "どこから始めましょう？",
    emailLabel: "メール",
    emailTitle: "対話を始める",
    emailIntro: "仕事のご相談、協業、少し詳しくお話ししたい内容に最適です。",
    primaryChannel: "おすすめの連絡方法",
    copyEmail: "メールをコピー",
    copied: "コピーしました",
    copyFailed: "コピーできませんでした",
    socialsLabel: "ソーシャルプロフィール",
    proofLabel: "プロフェッショナルな実績",
    professionalProfile: "職務プロフィール",
    buildingInPublic: "公開している仕事",
    linkedinProof: "職務経験・キャリア・推薦",
    githubProof: "公開コード・オープンソース・技術力",
    personalLabel: "仕事の外側",
    socials: {
